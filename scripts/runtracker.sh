...
# SINGLE_SEQUENCE="MOT17-02-DPM"
SINGLE_SEQUENCE="None"

cd dcf_mot
python sort.py --debug --det_score_division 1 --debug_vis_scale 1 --seq_path "../yolo_finn/runs/detect" --single_sequence ${SINGLE_SEQUENCE} --name ${NAME} --phase ${DETECTIONS} --config ${CONFIG} --debug_images ${DEBUG_IMAGES}
